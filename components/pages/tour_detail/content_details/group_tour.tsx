                ...
                <div className="flex flex-col gap-3">
                    <div className="border rounded-lg overflow-hidden shadow-md p-6 bg-white">
                        ...
                        <div className="mt-3 flex justify-around flex-wrap flex-col gap-1.5 text-base">
                            <p className="text-gray-700">Domestic: Rp{tour.groupTour.price.domestic.toLocaleString()} /person</p>
                            <p className="text-gray-700">International: Rp{tour.groupTour.price.foreign.toLocaleString()} /person</p>
                        </div>
                    </div>
                    <div className="border rounded-lg overflow-hidden shadow-md p-6 bg-white">
                        <h4 className="text-lg font-bold mb-3 text-purple-700 flex items-center">
                    ...
                    <div className="border rounded-lg overflow-hidden shadow-md p-6 bg-white">
                        <div className="text-base gap-1 mb-2 inline-flex items-center ">
                            <MdLocationPin className="text-purple-600 inline text-xl mr-2" /> <span className={'font-semibold text-purple-600'}>Meeting Point: </span> {tour.groupTour.meetingPoint}
                        </div>
                    </div>
                </div>
            </div>
